...
plot(data02$time_stamp, data02$Global_active_power, type = "l", xlab="", ylab="Global Active Power")
plot(data02$time_stamp, data02$Voltage, type = "l", xlab="datetime", ylab="Voltage")
...
plot(data02$time_stamp, data02$Global_reactive_power, type = "l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
